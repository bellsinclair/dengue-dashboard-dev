...
<template>
  <div class="main-content" style="background-color:#749ad0">
    <!-- Navbar -->
    <base-nav
        ...
        expand
    >
      <router-link slot="brand" class="navbar-brand mt-2 pr-3" to="/">
        <!-- LOGO -->
        <div style="width:175px" id="brand">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.08 31.07">
            <g id="Ebene_2" data-name="Ebene 2">
              <g id="Ebene_1-2" data-name="Ebene 1">
                ...
                <path
                    ...
                    style="fill:#fff"/>
                <path
                    d="M25.07,31.07H6a6,6,0,0,1-6-6V6A6,6,0,0,1,6,0H25.07a6,6,0,0,1,6,6V25.07A6,6,0,0,1,25.07,31.07ZM6,2A4,4,0,0,0,2,6V25.07a4,4,0,0,0,4,4H25.07a4,4,0,0,0,4-4V6a4,4,0,0,0-4-4Z"
                    style="fill:#fff"/>
                <rect x="6.44" y="6.09" width="3.64" height="20.06" style="fill:#fff"/>
                <path
                    d="M10.08,26.52H6.44a.37.37,0,0,1-.37-.37V6.09a.38.38,0,0,1,.37-.38h3.64a.38.38,0,0,1,.38.38V26.15A.37.37,0,0,1,10.08,26.52Zm-3.26-.75H9.71V6.46H6.82Z"
                    style="fill:#fff"/>
                <rect x="13.53" y="12.48" width="3.64" height="13.66" style="fill:#fff"/>
                <path
                    d="M17.17,26.52H13.53a.36.36,0,0,1-.37-.37V12.48a.37.37,0,0,1,.37-.37h3.64a.38.38,0,0,1,.38.37V26.15A.37.37,0,0,1,17.17,26.52Zm-3.26-.75H16.8V12.86H13.91Z"
                    style="fill:#fff"/>
                <rect x="20.62" y="8.7" width="3.64" height="17.44" style="fill:#fff"/>
                <path
                    d="M24.26,26.52H20.62a.36.36,0,0,1-.37-.37V8.7a.37.37,0,0,1,.37-.37h3.64a.37.37,0,0,1,.37.37V26.15A.36.36,0,0,1,24.26,26.52ZM21,25.77h2.88V9.08H21Z"
                    style="fill:#fff"/>
              </g>
            </g>
          </svg>
...
export default {
  ...
  data() {
    return {
      ...
      showMenu: false,
      admin: process.env.NODE_ENV === 'production' ? process.env.VUE_APP_ADMIN : 'admin',
    };
  },
};
</script>
